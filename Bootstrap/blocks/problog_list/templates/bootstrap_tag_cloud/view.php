<?php    
	...
	if(!empty($ttags)){
		...
		for ($i = 0; $i < $ttags->count(); $i++) {
			...
			echo '<span class="label white_text"><a href="'.BASE_URL.$search.'?'.$qs.'" style="font-size: '.$tagSizes[$akct->getSelectAttributeOptionUsageCount()].'px">'.$akct->getSelectAttributeOptionValue().'</a></span>';
